...
@Composable
fun AvailablePrintersBottomSheet(
    bottomSheetState: BottomSheetState,
    snackBarState: TUISnackBarState,
    items: ImmutableList<DiscoveredPrinterInfo>,
    onSelectItem: (selectedItem: DiscoveredPrinterInfo) -> Unit,
    ...
    EAMBottomSheet(
        ...
        bottomSheetState = bottomSheetState,
        style = HeaderWithTitle("Select Printer"),
